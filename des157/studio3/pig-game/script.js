        ...
        //    gameControl.innerHTML += '<img id="img2" src="2die.jpg">';
           ...
           setUpTurn();
            ...
            function setUpTurn() {
               ...
               game.innerHTML += '<img class ="img1" src="images/pig.png">'; 
               game.innerHTML += '<img class ="img2" src="images/pig.png">'; 
               game.innerHTML += '<img class="center1" src="images/1die.png">'; 
               game.innerHTML += '<img class="center2" src="images/2die.png">';
               showCurrentScore(); 
